...
if (isset($_FILES['profile_pic']) && $_FILES['profile_pic']['error'] === 0) {
    ...
    $target_dir = __DIR__ . "/uploads/profilepics/";
...
// Check if email already exists
    ...
    $sql = "INSERT INTO users (fullname, role, email, username, password, profile_pic) VALUES ('$fullname', '$role', '$email', '$username', '$password', '$profile_pic')";
